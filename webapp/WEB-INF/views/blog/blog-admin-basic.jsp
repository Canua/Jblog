			...
			<div id="content" class="full-screen">
				...
				<form action="${pageContext.request.contextPath }/${authUser.id }/upload" method="post" enctype="multipart/form-data">
				   	<table class="admin-config">
			      		...
			      		<tr>
			      			<td class="t">로고이미지</td>
			      			<td id = "logo"><img id="profile" style = "width:120px" onerror="this.src='${pageContext.request.contextPath }/assets/images/default_profile.png'" src="${pageContext.request.contextPath }/${blogVo.logo }">
			      		</tr>      		
			      		<tr>
			      			<td class="t">&nbsp;</td>
